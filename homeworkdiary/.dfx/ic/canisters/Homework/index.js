...
export const canisterId = process.env.HOMEWORK_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Homework.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Homework canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Homework.did.js")._SERVICE>}
 */
